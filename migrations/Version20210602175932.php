 ...
 */
final class Version20210602175932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotels ADD prix VARCHAR(255) DEFAULT NULL, CHANGE prix_nuit prix_nuit LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotels DROP prix, CHANGE prix_nuit prix_nuit VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
