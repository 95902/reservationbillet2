 ...
 */
final class Version20210603105340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voitures ADD image VARCHAR(255) NOT NULL, ADD is_clim TINYINT(1) DEFAULT NULL, ADD is_auto TINYINT(1) NOT NULL, ADD is_manuel TINYINT(1) DEFAULT NULL, ADD is_bagage TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voitures DROP image, DROP is_clim, DROP is_auto, DROP is_manuel, DROP is_bagage');
    }
}
