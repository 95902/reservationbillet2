 ...
 */
final class Version20210603090425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotels ADD is_plage TINYINT(1) DEFAULT NULL, ADD is_clim TINYINT(1) DEFAULT NULL, ADD is_sport TINYINT(1) DEFAULT NULL, ADD is_bar TINYINT(1) DEFAULT NULL, ADD is_restaurant TINYINT(1) DEFAULT NULL, ADD is_parking TINYINT(1) DEFAULT NULL, CHANGE prix_nuit prix_nuit DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotels DROP is_plage, DROP is_clim, DROP is_sport, DROP is_bar, DROP is_restaurant, DROP is_parking, CHANGE prix_nuit prix_nuit LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
