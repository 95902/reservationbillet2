 ...
 */
final class Version20210601225940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotels CHANGE prix_nuit prix_nuit LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotels CHANGE prix_nuit prix_nuit DOUBLE PRECISION NOT NULL');
    }
}
