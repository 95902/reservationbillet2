 ...
 */
final class Version20210601080710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voyages ADD created_at DATETIME NOT NULL, ADD tags LONGTEXT DEFAULT NULL, ADD slug VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voyages DROP created_at, DROP tags, DROP slug');
    }
}
